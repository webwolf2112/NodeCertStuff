...
// in that order. Don't alter the filename extension string in any way
// before passing it to your module.

// The callback function must be called using the idiomatic node(err, data)
// convention. This convention stipulates that unless there's an error, the
// first argument passed to the callback will be null, and the second will
// be your data. In this exercise, the data will be your filtered list of
// files, as an Array. If you receive an error, e.g. from your call to
...
const printToConsole = ( err, listOfFiles ) => {
    if (err) throw new Error( err );
    listOfFiles.forEach( file => console.log( file ));
};

readDir(dir, ext, printToConsole );
